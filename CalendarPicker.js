 ...
 * @Modified by ANHNHAT - 14 October 2020.
 */
...
function CalendarPicker(element, options) {
    ...
    this.listOfAllDaysAsText = new Array();
    this.listOfAllDaysAsText['vi'] = [
        'T2',
        'T3',
        'T4',
        'T5',
    ...
    this.listOfAllMonthsAsText = new Array();
    this.listOfAllMonthsAsText['vi'] = [
        'Tháng 1',
        'Tháng 2',
        'Tháng 3',
        'Tháng 4',
...
CalendarPicker.prototype._insertHeaderIntoCalendarWrapper = function() {
    this.calendarHeaderTitle.textContent = `${this.listOfAllMonthsAsText[this.lang][this.month]} - ${this.year}`;
...
CalendarPicker.prototype._insertCalendarGridDaysHeader = function() {
    this.listOfAllDaysAsText[this.lang].forEach(day => {
...
CalendarPicker.prototype._updateCalendar = function() {
    ...
    window.requestAnimationFrame(function() {
        that.calendarHeaderTitle.textContent = `${that.listOfAllMonthsAsText[that.lang][that.month]} - ${that.year}`;
